...
#### [Часть 3: Наблюдение за процессом выбора протоколом STP порта, исходя из стоимости портов](#измените-стоимость-порта)
#### [Часть 4: Наблюдение за процессом выбора протоколом STP порта, исходя из приоритета портов](#выбор-по-приоритету-порта)
...
Cхема лабораторного стенда, после выполненная действий:
...
![Image alt](https://github.com/Misha-cook/otus-networks/blob/main/labs/lab02/%D0%A0%D0%B8%D1%81%D1%83%D0%BD%D0%BE%D0%BA_16.png)

Основные изменения вызванные добовлением дополнительных линков привели к пересмотру назначения портов, пример для S1

![Image alt](https://github.com/Misha-cook/otus-networks/blob/main/labs/lab02/%D0%A0%D0%B8%D1%81%D1%83%D0%BD%D0%BE%D0%BA_17.png)

Алогоритм выбора портов на S1 и S3 аналогичен
